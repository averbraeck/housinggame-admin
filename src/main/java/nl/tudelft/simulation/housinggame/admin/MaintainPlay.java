            ...
            final boolean edit)
    {
        ...
        TableForm form = new TableForm()
                ...
                .addEntry(new TableEntryInt(Tables.PLAYERROUND.COST_PLUVIAL_DAMAGE)
                        ...
                        .setMin(0))
                .addEntry(new TableEntryInt(Tables.PLAYERROUND.CURRENT_SPENDABLE_INCOME)
                        .setRequired()
                        .setInitialValue(playerRound.getCurrentSpendableIncome(), 0)
                ...
                .addEntry(new TableEntryInt(Tables.PLAYERROUND.SATISFACTION_DEBT_PENALTY)
                        ...
                        .setMin(0))
                .addEntry(new TableEntryInt(Tables.PLAYERROUND.CURRENT_PERSONAL_SATISFACTION)
                        .setRequired()
                        .setInitialValue(playerRound.getCurrentPersonalSatisfaction(), 0)
                        .setLabel("Final pers sat")
                        .setMin(0))
                .addEntry(new TableEntryInt(Tables.PLAYERROUND.CURRENT_HOUSE_SATISFACTION)
                        .setRequired()
                        .setInitialValue(playerRound.getCurrentHouseSatisfaction(), 0)
