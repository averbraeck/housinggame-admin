            ...
            final boolean edit)
    {
        ...
        TableForm form = new TableForm()
                ...
                .addEntry(new TableEntryInt(Tables.SCENARIOPARAMETERS.SATISFACTION_HOUSE_RATING_TOO_LOW_PER_DELTA)
                        ...
                        .setMin(0))
                .addEntry(new TableEntryBoolean(Tables.SCENARIOPARAMETERS.SATISFACTION_HOUSE_RATING_PER_ROUND)
                        .setRequired()
                        .setInitialValue(scenarioParameters.getSatisfactionHouseRatingPerRound(), (byte) 0)
                        .setLabel("Apply satisfaction house rating every round?"))
                ...
                .addEntry(new TableEntryInt(Tables.SCENARIOPARAMETERS.HIGHEST_FLUVIAL_SCORE)
                        .setRequired()
                        .setInitialValue(scenarioParameters.getHighestFluvialScore(), 0)
                        .setLabel("Highest fluvial dice roll")
                        .setMin(0))
                .addEntry(new TableEntryInt(Tables.SCENARIOPARAMETERS.HIGHEST_PLUVIAL_SCORE)
                        .setRequired()
                        .setInitialValue(scenarioParameters.getHighestPluvialScore(), 0)
                        .setLabel("Highest pluvial dice roll")
                        .setMin(0))
