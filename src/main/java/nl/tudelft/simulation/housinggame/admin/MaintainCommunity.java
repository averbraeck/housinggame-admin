    ...
    public static void editCommunity(final HttpSession session, final AdminData data, final int communityId, final boolean edit)
    {
        ...
        TableForm form = new TableForm()
                ...
                .addEntry(new TableEntryInt(Tables.COMMUNITY.CAPACITY)
                        ...
                        .setLabel("Capacity")
                        .setMin(0))
                .addEntry(new TableEntryInt(Tables.COMMUNITY.FLUVIAL_PROTECTION)
                        .setRequired()
                        .setInitialValue(community.getFluvialProtection(), 0)
                        .setLabel("Protection river flood")
                        .setMin(0))
                .addEntry(new TableEntryInt(Tables.COMMUNITY.PLUVIAL_PROTECTION)
                        .setRequired()
                        .setInitialValue(community.getPluvialProtection(), 0)
