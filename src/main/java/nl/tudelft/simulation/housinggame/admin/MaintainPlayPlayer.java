            ...
            final boolean edit)
    {
        ...
        TableForm form = new TableForm()
                ...
                .addEntry(new TableEntryInt(Tables.PLAYERROUND.COST_TAXES)
                        ...
                        .setLabel("Cost taxes")
                        .setMin(0))
                .addEntry(new TableEntryInt(Tables.PLAYERROUND.COST_HOUSE_MEASURES_BOUGHT)
                        .setRequired()
                        .setInitialValue(playerRound.getCostHouseMeasuresBought(), 0)
                        .setLabel("Cost house measures bought")
                        .setMin(0))
                .addEntry(new TableEntryInt(Tables.PLAYERROUND.COST_PERSONAL_MEASURES_BOUGHT)
                        .setRequired()
                        .setInitialValue(playerRound.getCostPersonalMeasuresBought(), 0)
                        .setLabel("Cost personal measures bought")
                        .setMin(0))
                ...
                .addEntry(new TableEntryInt(Tables.PLAYERROUND.SATISFACTION_HOUSE_MEASURES)
                        ...
                        .setMin(0))
                .addEntry(new TableEntryInt(Tables.PLAYERROUND.SATISFACTION_PERSONAL_MEASURES)
                        .setRequired()
                        .setInitialValue(playerRound.getSatisfactionPersonalMeasures(), 0)
                        .setLabel("Satisfaction personal measures")
                        .setMin(0))
                ...
                .addEntry(new TableEntryInt(Tables.PLAYERROUND.SATISFACTION_DEBT_PENALTY)
                        ...
                        .setMin(0))
                .addEntry(new TableEntryInt(Tables.PLAYERROUND.SATISFACTION_TOTAL)
                        .setRequired()
                        .setInitialValue(playerRound.getSatisfactionTotal(), 0)
                        .setLabel("Total (running) satisfaction"))
