            ...
            final boolean edit)
    {
        ...
        TableForm form = new TableForm()
                ...
                .addEntry(new TableEntryInt(Tables.PLAYERROUND.SATISFACTION_DEBT_PENALTY)
                        ...
                        .setMin(0))
                .addEntry(new TableEntryInt(Tables.PLAYERROUND.SATISFACTION_PERSONAL_TOTAL)
                        .setRequired()
                        .setInitialValue(playerRound.getSatisfactionPersonalTotal(), 0)
                        .setLabel("Total personal satisfaction"))
