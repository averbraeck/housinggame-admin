...
public class GroupRecord extends UpdatableRecordImpl<GroupRecord> implements Record7<UInteger, String, String, UInteger, UInteger, UInteger, UInteger> {
    ...
    /**
     * Setter for <code>housinggame.group.current_round_id</code>.
     */
    public void setCurrentRoundId(UInteger value) {
        set(6, value);
    }

    /**
     * Getter for <code>housinggame.group.current_round_id</code>.
     */
    public UInteger getCurrentRoundId() {
    ...
    public Field<UInteger> field7() {
        return Group.GROUP.CURRENT_ROUND_ID;
    }
     ...
     */
    public GroupRecord(UInteger id, String name, String password, UInteger gamesessionId, UInteger scenarioId, UInteger facilitatorId, UInteger currentRoundId) {
        super(Group.GROUP);
        ...
        setCurrentRoundId(currentRoundId);
