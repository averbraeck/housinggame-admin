...
public class Indexes {
    ...
    public static final Index NEWSPARAMETERS_FK_NEWSPARAMETERS_COMMUNITY1_IDX = Internal.createIndex(DSL.name("fk_newsparameters_community1_idx"), Newsparameters.NEWSPARAMETERS, new OrderField[] { Newsparameters.NEWSPARAMETERS.COMMUNITY_ID }, false);
    public static final Index NEWSPARAMETERS_FK_NEWSPARAMETERS_NEWSITEM1_IDX = Internal.createIndex(DSL.name("fk_newsparameters_newsitem1_idx"), Newsparameters.NEWSPARAMETERS, new OrderField[] { Newsparameters.NEWSPARAMETERS.NEWSITEM_ID }, false);
