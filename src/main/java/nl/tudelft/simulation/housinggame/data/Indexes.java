...
public class Indexes {
    ...
    public static final Index LABEL_FK_LABEL_LANGUAGES1_IDX = Internal.createIndex(DSL.name("fk_label_languages1_idx"), Label.LABEL, new OrderField[] { Label.LABEL.LANGUAGES_ID }, false);
