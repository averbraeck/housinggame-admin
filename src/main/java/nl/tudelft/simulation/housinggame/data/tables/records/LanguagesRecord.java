...
public class LanguagesRecord extends UpdatableRecordImpl<LanguagesRecord> implements Record5<UInteger, UInteger, UInteger, UInteger, UInteger> {
    ...
    @Override
    public LanguagesRecord value2(UInteger value) {
    ...
    @Override
    public LanguagesRecord values(UInteger value1, UInteger value2, UInteger value3, UInteger value4, UInteger value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public LanguagesRecord(UInteger id, UInteger languageId1, UInteger languageId2, UInteger languageId3, UInteger languageId4) {
        super(Languages.LANGUAGES);
