...
public class Keys {
    ...
    public static final ForeignKey<FacilitatorRecord, GamesessionRecord> FK_FACILITATOR_GAMESESSION1 = Internal.createForeignKey(Facilitator.FACILITATOR, DSL.name("fk_facilitator_gamesession1"), new TableField[] { Facilitator.FACILITATOR.GAMESESSION_ID }, Keys.KEY_GAMESESSION_PRIMARY, new TableField[] { Gamesession.GAMESESSION.ID }, true);
    ...
    public static final ForeignKey<GamesessionRecord, ScenarioRecord> FK_GAMESESSION_SCENARIO1 = Internal.createForeignKey(Gamesession.GAMESESSION, DSL.name("fk_gamesession_scenario1"), new TableField[] { Gamesession.GAMESESSION.SCENARIO_ID }, Keys.KEY_SCENARIO_PRIMARY, new TableField[] { Scenario.SCENARIO.ID }, true);
    ...
    public static final ForeignKey<GroupRecord, RoundRecord> FK_GROUP_ROUND1 = Internal.createForeignKey(Group.GROUP, DSL.name("fk_group_round1"), new TableField[] { Group.GROUP.CURRENT_ROUND_ID }, Keys.KEY_ROUND_PRIMARY, new TableField[] { Round.ROUND.ID }, true);
    ...
    public static final ForeignKey<MeasuretypeRecord, ScenarioRecord> FK_MEASURETYPE_SCENARIO1 = Internal.createForeignKey(Measuretype.MEASURETYPE, DSL.name("fk_measuretype_scenario1"), new TableField[] { Measuretype.MEASURETYPE.SCENARIO_ID }, Keys.KEY_SCENARIO_PRIMARY, new TableField[] { Scenario.SCENARIO.ID }, true);
    ...
    public static final ForeignKey<PlayerRecord, ScenarioRecord> FK_PLAYER_SCENARIO1 = Internal.createForeignKey(Player.PLAYER, DSL.name("fk_player_scenario1"), new TableField[] { Player.PLAYER.SCENARIO_ID }, Keys.KEY_SCENARIO_PRIMARY, new TableField[] { Scenario.SCENARIO.ID }, true);
    ...
    public static final ForeignKey<PlayerroundRecord, GroupRecord> FK_PLAYERROUND_GROUP1 = Internal.createForeignKey(Playerround.PLAYERROUND, DSL.name("fk_playerround_group1"), new TableField[] { Playerround.PLAYERROUND.GROUP_ID }, Keys.KEY_GROUP_PRIMARY, new TableField[] { Group.GROUP.ID }, true);
