...
public class Keys {
    ...
    public static final ForeignKey<ScenarioparametersRecord, LanguageRecord> FK_SCENARIOPARAMETERS_LANGUAGE1 = Internal.createForeignKey(Scenarioparameters.SCENARIOPARAMETERS, DSL.name("fk_scenarioparameters_language1"), new TableField[] { Scenarioparameters.SCENARIOPARAMETERS.DEFAULT_LANGUAGE }, Keys.KEY_LANGUAGE_PRIMARY, new TableField[] { Language.LANGUAGE.ID }, true);
