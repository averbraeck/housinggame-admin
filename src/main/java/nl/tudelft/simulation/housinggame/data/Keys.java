...
public class Keys {
    ...
    public static final UniqueKey<LabelRecord> KEY_LABEL_KEY_UNIQUE = Internal.createUniqueKey(Label.LABEL, DSL.name("KEY_label_key_UNIQUE"), new TableField[] { Label.LABEL.LANGUAGES_ID, Label.LABEL.KEY }, true);
    ...
    public static final ForeignKey<LabelRecord, LanguagesRecord> FK_LABEL_LANGUAGES1 = Internal.createForeignKey(Label.LABEL, DSL.name("fk_label_languages1"), new TableField[] { Label.LABEL.LANGUAGES_ID }, Keys.KEY_LANGUAGES_PRIMARY, new TableField[] { Languages.LANGUAGES.ID }, true);
