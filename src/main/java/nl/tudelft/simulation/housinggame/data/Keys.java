...
public class Keys {
    ...
    public static final ForeignKey<GameversionRecord, LanguageRecord> FK_GAMEVERSION_LANGUAGE1 = Internal.createForeignKey(Gameversion.GAMEVERSION, DSL.name("fk_gameversion_language1"), new TableField[] { Gameversion.GAMEVERSION.LANGUAGE_ID }, Keys.KEY_LANGUAGE_PRIMARY, new TableField[] { Language.LANGUAGE.ID }, true);
