...
public class ScenarioparametersRecord extends UpdatableRecordImpl<ScenarioparametersRecord> implements Record13<UInteger, String, Double, Double, Double, Double, Double, Double, Double, Double, Double, Double, String> {
    ...
    /**
     * Setter for <code>housinggame.scenarioparameters.language</code>.
     */
    ...
    /**
     * Getter for <code>housinggame.scenarioparameters.language</code>.
     */
    ...
    @Override
    public Row13<UInteger, String, Double, Double, Double, Double, Double, Double, Double, Double, Double, Double, String> valuesRow() {
    ...
    public Field<String> field13() {
        return Scenarioparameters.SCENARIOPARAMETERS.LANGUAGE;
    }
    ...
    @Override
    public ScenarioparametersRecord value13(String value) {
        setLanguage(value);
        return this;
    }

    @Override
    public ScenarioparametersRecord values(UInteger value1, String value2, Double value3, Double value4, Double value5, Double value6, Double value7, Double value8, Double value9, Double value10, Double value11, Double value12, String value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ScenarioparametersRecord(UInteger id, String name, Double pluvialRepairCosts, Double pluvialSatisfactionPenalty, Double fluvialRepairCosts, Double fluvialSatisfactionPenalty, Double satisfactionDebtPenalty, Double satisfactionHouseRatingChange, Double satisfactionMovePenalty, Double floodRepairCost, Double floodSatisfactionPenalty, Double mortgagePercentage, String language) {
        super(Scenarioparameters.SCENARIOPARAMETERS);
