...
public class Keys {
    ...
    public static final ForeignKey<GroupRecord, RoundRecord> FK_GROUP_ROUND1 = Internal.createForeignKey(Group.GROUP, DSL.name("fk_group_round1"), new TableField[] { Group.GROUP.ROUND_ID }, Keys.KEY_ROUND_PRIMARY, new TableField[] { Round.ROUND.ID }, true);
